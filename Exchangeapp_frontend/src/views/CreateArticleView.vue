          ...
          <el-form-item label="文章摘要" prop="preview">
            <div class="preview-input-wrapper">
              <el-input
                ...
                type="textarea"
                :rows="3"
                :placeholder="form.autoGeneratePreview ? 'AI将自动生成摘要...' : '简要描述文章内容...'"
                maxlength="200"
                show-word-limit
                :disabled="form.autoGeneratePreview"
              />
              <el-checkbox v-model="form.autoGeneratePreview" class="auto-generate-checkbox">
                AI自动生成摘要
              </el-checkbox>
            </div>
          </el-form-item>
